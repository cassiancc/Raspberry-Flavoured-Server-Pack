...
// Set block breaking speed
	...
	breakFast('frame_changer:obsidian_bricks', 8)
	breakFast('frame_changer:obsidian_brick_slab', 8)
	breakFast('frame_changer:obsidian_brick_stairs', 8)
	breakFast('frame_changer:obsidian_brick_wall', 8)
	breakFast('frame_changer:crying_obsidian_bricks', 8)
	breakFast('frame_changer:crying_obsidian_brick_slab', 8)
	breakFast('frame_changer:crying_obsidian_brick_stairs', 8)
	breakFast('frame_changer:crying_obsidian_brick_wall', 8)
	breakFast('frame_changer:polished_obsidian', 8)
	breakFast('frame_changer:polished_obsidian_slab', 8)
	breakFast('frame_changer:polished_obsidian_stairs', 8)
	breakFast('frame_changer:polished_obsidian_wall', 8)
	breakFast('frame_changer:crying_polished_obsidian', 8)
	breakFast('frame_changer:crying_polished_obsidian_slab', 8)
	breakFast('frame_changer:crying_polished_obsidian_stairs', 8)
	breakFast('frame_changer:crying_polished_obsidian_wall', 8)
	breakFast('frame_changer:obsidian_pillar', 8)
	breakFast('frame_changer:crying_obsidian_pillar', 8)
	breakFast('frame_changer:chiseled_obsidian', 8)
	breakFast('frame_changer:crying_chiseled_obsidian', 8)
	breakFast('architects_palette:unobtanium_block', 8)
	breakFast('architects_palette:abyssaline', 8)
	breakFast('architects_palette:abyssaline_bricks', 8)
	breakFast('architects_palette:abyssaline_brick_slab', 8)
	breakFast('architects_palette:abyssaline_tiles', 8)
	breakFast('architects_palette:abyssaline_tile_slab', 8)
	breakFast('architects_palette:chiseled_abyssaline_bricks', 8)
	breakFast('architects_palette:abyssaline_pillar', 8)
	breakFast('architects_palette:abyssaline_lamp', 8)
	breakFast('architects_palette:abyssaline_plating', 8)
	breakFast('architects_palette:hadaline', 8)
	breakFast('architects_palette:hadaline_bricks', 8)
	breakFast('architects_palette:hadaline_brick_slab', 8)
	breakFast('architects_palette:hadaline_tiles', 8)
	breakFast('architects_palette:hadaline_tile_slab', 8)
	breakFast('architects_palette:chiseled_hadaline_bricks', 8)
	breakFast('architects_palette:hadaline_pillar', 8)
