...
const electrumHelmetSpeed = new $AttributeModifier("1ceb2194-31e5-4e70-a890-ad940882e4a5", "generic.movement_speed", 0.08, "MULTIPLY_BASE")
...
const electrumLeggingsSpeed = new $AttributeModifier("c4822ccc-635c-42de-b667-2d9684a13aac", "generic.movement_speed", 0.08, "MULTIPLY_BASE")
const electrumBootsSpeed = new $AttributeModifier("6bebb8d2-f3a0-4fe0-9ceb-ac6179061994", "generic.movement_speed", 0.08, "MULTIPLY_BASE")

const roseGoldHelmetMagProt = new $AttributeModifier("1df33c7e-aac7-4c2d-8e14-8a4540f80766", "caverns_and_chasms:magic_protection", 0.1625, "ADDITION")
const roseGoldChestplateMagProt = new $AttributeModifier("28eaeebe-88dc-4b93-bce0-71f7805b8b76", "caverns_and_chasms:magic_protection", 0.1625, "ADDITION")
const roseGoldLeggingsMagProt = new $AttributeModifier("197274db-98d0-4dfb-ab36-b452acb600ef", "caverns_and_chasms:magic_protection", 0.1625, "ADDITION")
const roseGoldBootsMagProt = new $AttributeModifier("acb332d4-14ce-45bf-b653-b814cb457b02", "caverns_and_chasms:magic_protection", 0.1625, "ADDITION")

const sanguineHelmetLifesteal = new $AttributeModifier("4e857af6-37cf-4d9e-82bf-2e78a8156cdd", "caverns_and_chasms:lifesteal", 0.1, "ADDITION")
const sanguineChestplateLifesteal = new $AttributeModifier("7e817302-aa59-4a51-81e9-0559866d66e6", "caverns_and_chasms:lifesteal", 0.1, "ADDITION")
const sanguineLeggingsLifesteal = new $AttributeModifier("2ebde93d-eaa7-4df7-b562-a427de634c14", "caverns_and_chasms:lifesteal", 0.1, "ADDITION")
const sanguineBootsLifesteal = new $AttributeModifier("e0ba6892-11b6-4bc1-a093-c6969dd45e19", "caverns_and_chasms:lifesteal", 0.1, "ADDITION")
...
const leatherFalling = new $AttributeModifier("62b10ab0-c5da-49d8-a42e-2483f07cd7c4", "kubejs:feather_falling", 0.2, "ADDITION")
const goldArmourFireProt = new $AttributeModifier("5deccdc7-6911-4e5b-a4b9-bd85ed836313", "kubejs:fire_protection", 0.15, "ADDITION")
const netheriteArmourFireProt = new $AttributeModifier("c758a669-71e1-4761-b9f1-fa835b4a74fe", "kubejs:fire_protection", 0.3, "ADDITION")
const steelArmourProjProt = new $AttributeModifier("8dac7f12-5057-47d2-a4be-82c2919eb864", "kubejs:projectile_protection", 0.2, "ADDITION")
...
//    if (event.itemStack.id == "kubejs:electrum_horse_armor" && event.slotType == "chest") {
//        event.addModifier("minecraft:generic.movement_speed", new $AttributeModifier(UUID.fromString('4cbad1f0-5d16-404c-a4bd-c3bf2f9980a7'), 'Tool modifier', 0.075, 'multiply_base'))
//    }
...
// Fake attributes
	...
	if (event.itemStack.id == "minecraft:leather_helmet" && event.slotType == "head") {
		event.addModifier("kubejs:feather_falling", leatherFalling)
	}
	...
	if (event.itemStack.id == "alloyed:steel_helmet" && event.slotType == "head") {
		event.addModifier("kubejs:projectile_protection", steelArmourProjProt)
	}
	if (event.itemStack.id == "alloyed:steel_chestplate" && event.slotType == "chest") {
		event.addModifier("kubejs:projectile_protection", steelArmourProjProt)
	}
	if (event.itemStack.id == "alloyed:steel_leggings" && event.slotType == "legs") {
		event.addModifier("kubejs:projectile_protection", steelArmourProjProt)
	}
	if (event.itemStack.id == "alloyed:steel_boots" && event.slotType == "feet") {
		event.addModifier("kubejs:projectile_protection", steelArmourProjProt)
	}
