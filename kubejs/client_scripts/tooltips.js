...
ItemEvents.tooltip(tooltip => {
  ...
  tooltip.add(['kubejs:sporedough'], "§9Causes Small Explosion")
  tooltip.add(['caverns_and_chasms:bejeweled_apple'], "§9Inflicts 2 Random Effects")
...
// cat food
  tooltip.addAdvanced('kubejs:cat_food', (item, advanced, text) => {
      text.add(1, [Text.of('When fed to a trusting').gray()])
      text.add(2, [Text.of('Ocelot or a tamed Cat:').gray()])
      text.add(3, [Text.of(' Speed (5:00').blue()])
      text.add(4, [Text.of(' Regeneration (5:00)').blue()])
      text.add(5, [Text.of(' Resistance (5:00)').blue()])
      text.add(6, [Text.of(' Turns Ocelot into tamed Cat').blue()])
  })
  
// hot cream cone
  tooltip.addAdvanced('mynethersdelight:hot_cream_cone', (item, advanced, text) => {
      text.add(1, [Text.of('Clears 1 Effect').blue()])
      text.add(2, [Text.of('Burning Blood (0:10)').blue()])
      text.add(3, [Text.of('Fire Resistance (0:10)').blue()])
      text.add(4, [Text.of('When fed to a Strider:').gray()])
      text.add(5, [Text.of(' Speed II (5:00)').blue()])
  })
  
// dim tears
  tooltip.addAdvanced('spelunkery:portal_fluid_bottle', (item, advanced, text) => {
      text.add(1, [Text.of('When consumed:').gray()])
      text.add(2, [Text.of(' Warps to Respawn Point').blue()])
...
// toms simple storage
  tooltip.addAdvanced('toms_storage:ts.inventory_connector', (item, advanced, text) => {
    if (!tooltip.shift) {
      ...
      text.add(2, [Text.of('')])
      text.add(3, [Text.of('Not to be confused with the ').color('#C7954B').bold(), Text.of('Portable Storage Interface').color('#EEDA78').bold(), Text.of('!').color('#C7954B').bold()])
      text.add(4, [Text.of('Internally merges all of the connected ').color('#C7954B'), Text.of('storage blocks\'').color('#EEDA78')])
      text.add(5, [Text.of('inventories into one.').color('#C7954B')])
      text.add(6, [Text.of('')])
      text.add(7, [Text.of('Can be used in tandem with a ').color('#C7954B'), Text.of('Storage Terminal').color('#EEDA78')])
      text.add(8, [Text.of('to manually access ').color('#C7954B'), Text.of('all items').color('#EEDA78'), Text.of(' inside of all').color('#C7954B')])
      text.add(9, [Text.of('inventories merged together by the ').color('#C7954B'), Text.of('Storage Interface').color('#EEDA78'), Text.of('.').color('#C7954B')])
      text.add(10, [Text.of('')])
      text.add(11, [Text.of('When R-Clicked').gray()])
      text.add(12, [Text.of(' Briefly displays the ').color('#C7954B'), Text.of('maximum amount').color('#EEDA78')])
      text.add(13, [Text.of(' of connected ').color('#C7954B'), Text.of('storage slots').color('#EEDA78')])
      text.add(14, [Text.of(' and how many are ').color('#C7954B'), Text.of('currently available').color('#EEDA78'), Text.of('.').color('#C7954B')])
    }
  })
  tooltip.addAdvanced('toms_storage:ts.storage_terminal', (item, advanced, text) => {
    if (!tooltip.shift) {
      ...
      text.add(1, [Text.of('Hold [').darkGray(), Text.of('Shift').white(), Text.of('] for Summary').darkGray()])
      text.add(2, [Text.of('')])
      text.add(3, [Text.of('Grants access to ').color('#C7954B'), Text.of('all items').color('#EEDA78'), Text.of(' inside of a').color('#C7954B')])
      text.add(4, [Text.of('storage block ').color('#EEDA78'), Text.of('it\'s placed on,').color('#C7954B')])
      text.add(5, [Text.of('in a nifty menu with').color('#C7954B'), Text.of(' various functions').color('#EEDA78'), Text.of('.').color('#C7954B')])
      text.add(6, [Text.of('')])
      text.add(7, [Text.of('When Placed on Storage Interface').gray()])
      text.add(8, [Text.of(' Grants access to ').color('#C7954B'), Text.of('all items').color('#EEDA78'), Text.of(' in').color('#C7954B')])
      text.add(9, [Text.of(' all storage blocks ').color('#EEDA78'), Text.of('connected to the').color('#C7954B')])
