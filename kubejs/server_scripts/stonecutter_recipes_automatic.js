...
// adds stonecutter recipes for blocksets covered by conversion_tags_automatic.js and removes some redundant/unobtainable recipes. script by noodleblitz
ServerEvents.recipes(event => {
	...
	'#raspberry_flavoured:large_brick',
	'#raspberry_flavoured:mossy_large_brick',
	...
	'#raspberry_flavoured:oraclestone',
	'#raspberry_flavoured:dark_oraclestone',
	'#raspberry_flavoured:entrails',
	'#raspberry_flavoured:feldspar',
	'#raspberry_flavoured:enigmatic_tile',
	'#raspberry_flavoured:cement'
	]
