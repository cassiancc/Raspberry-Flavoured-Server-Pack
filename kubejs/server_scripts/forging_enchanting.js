...
// Enchanting tablets
	// Blank
	event.custom({type: 'miningmaster:forging_recipe', gems: [{item: 'minecraft:amethyst_shard'}, {item: 'minecraft:amethyst_shard'}, {item: 'minecraft:amethyst_shard'}, {item: 'minecraft:amethyst_shard'}, {item: 'minecraft:amethyst_shard'}, {item: 'minecraft:amethyst_shard'}, {item: 'minecraft:amethyst_shard'}, {item: 'minecraft:amethyst_shard'}, {item: 'minecraft:amethyst_shard'}], catalyst: {tag: 'forge:stone'}, result: {item: 'kubejs:blank_tablet', count: 2}})
	// Aquatic
	...
	event.custom({type: 'miningmaster:forging_recipe', gems: [{item: 'minecraft:rabbit_foot'}, {item: 'minecraft:rabbit_foot'}], catalyst: {item: 'kubejs:blank_tablet'}, result: {item: 'kubejs:beastly_tablet'}})
	...
	// Enduring
	event.custom({type: 'miningmaster:forging_recipe', gems: [{tag: 'raspberry_flavoured:golden_healers'}, {tag: 'raspberry_flavoured:golden_healers'}, {tag: 'raspberry_flavoured:golden_healers'}, {tag: 'raspberry_flavoured:golden_healers'}], catalyst: {item: 'kubejs:blank_tablet'}, result: {item: 'kubejs:enduring_tablet'}})
	// Everlasting
	...
	// Frost
	event.custom({type: 'miningmaster:forging_recipe', gems: [{item: 'minecraft:blue_ice'}, {item: 'minecraft:blue_ice'}, {item: 'minecraft:blue_ice'}, {item: 'minecraft:blue_ice'}, {item: 'minecraft:blue_ice'}], catalyst: {item: 'kubejs:blank_tablet'}, result: {item: 'kubejs:frost_tablet'}})
	// Hallowed
	event.custom({type: 'miningmaster:forging_recipe', gems: [{item: 'oreganized:silver_ingot'}, {item: 'oreganized:silver_ingot'}, {item: 'oreganized:silver_ingot'}], catalyst: {item: 'kubejs:blank_tablet'}, result: {item: 'kubejs:hallowed_tablet'}})
	// Haunted
