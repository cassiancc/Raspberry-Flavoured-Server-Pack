...
EntityEvents.spawned((event) => {
    const { entity } = event;
    const blacklistEntities = ['create:carriage_contraption', 'create:contraption', 'create:crafting_blueprint', 'create:gantry_contraption', 'create:seat', 'create:stationary_contraption']
