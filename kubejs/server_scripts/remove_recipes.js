...
// Removing by ID
	...
	"minecraft:shield",
	"modestmasonry:smelting/cracked_adobe_bricks",
	...
	"minecraft:charcoal",
	"twigs:silt_from_silt_balls",
	"create:compat/atmospheric/splashing/arid_sand",
	"quark:building/crafting/shingles/shingles",
	"twigs:silt_shingles",
	"sullysmod:crafting/polished_jade_shingles",
	"environmental:smooth_mud",
	"minecraft:mud_bricks",
	"create_central_kitchen:compacting/aloe_gel",
	...
	"spelunkery:sandpaper_polishing/emerald_block",
	"create_central_kitchen:filling/mulberry_bread",
	"create_central_kitchen:filling/honey_bread",
...
// Removing by both input and output
	...
	event.remove({type: "spelunkery:grindstone_polishing"})
	event.remove({type: "sullysmod:grindstone_polishing"})
	event.remove({type: "modestmining:milling"})
	event.remove({type: "farmersdelight:cutting", mod: "aquaculturedelight"})
	event.remove({output: "#quark:crystal_lamp", input: "minecraft:redstone"})
